...
public class Line {
	...
	{
		double d1 = end2.getX() - end1.getX();
		double d2 = end2.getY() - end1.getY();
		double d3 = Math.pow(d1,2) + Math.pow(d2,2);
		double result = Math.sqrt(d3); 
		return result;
	}
	public Point midpoint()
	{
		double m1 = (end2.getX() + end1.getX())/2;
		double m2 = (end2.getY() + end1.getY())/2;
		Point result = new Point(m1,m2);
		return result;
	}
